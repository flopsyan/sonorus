...
const STROKE = {
  ...
  // The sidebar toggle: a frame with the left column marked off.
  'panel-left': '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9.5 4v16"/>',
  // The two ways a collection can be shown: tiles, or one line per entry.
  ...
  rows: '<path d="M4 7h16M4 12h16M4 17h16"/><circle cx="4" cy="7" r="0.9"/><circle cx="4" cy="12" r="0.9"/><circle cx="4" cy="17" r="0.9"/>',
  ...
  // eBooks: pages rather than covers, so the shelf is not the audiobook icon
  // a second time.
  'book-open': '<path d="M12 6.8C10.4 5.6 8.4 5 6 5H3.2v12.4H6c2.4 0 4.4.6 6 1.8"/><path d="M12 6.8C13.6 5.6 15.6 5 18 5h2.8v12.4H18c-2.4 0-4.4.6-6 1.8"/><path d="M12 6.8V19.2"/>',
